...
public class SC {
  ...
  public static void InsertTuple() {
    ...
    try {
      ...
      if(sno.equals("")) {
        System.out.println("Insert Error: Primary key 'student number' can not be null!\n");
      } else if(cno.equals("")) {
        ...
        stmt.executeLargeUpdate("insert into sc "
                              + "values('" + sno + "', '" + cno +  "', '" + time + "', '" + grade + "');");
  ...
  public static void DeleteTuple() {
    ...
    try {
      ...
      if(sno.equals("")) {
        ...
        stmt.executeLargeUpdate("delete from sc "
                              + "where sno = '" + sno + "' and "
                              + "cno = '" + cno + "' and "
                              + "time = '" + time + "';");
